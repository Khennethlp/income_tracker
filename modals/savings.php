<div class="modal fade bd-example-modal-xl" id="savings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content" style="border-radius: 18px;">
            ...
            <div class="modal-footer ">
                <div class="col-md-8">
                    <button class="btn btn-block btn_confirm" onclick="amount_saved();">Confirm</button>
                </div>
            </div>
        </div>
    </div>
